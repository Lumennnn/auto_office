...
if __name__ == '__main__':
    ...
    put_table([['序号', '时间段'], ['①', '半天（8:00-12:00）'], ['②', '半天（14:00-17:50）'],
               ['③', '一天（8:00-17:50）'], ['④', '一天（8:00-21:00）'], ['⑤', '晚上（19:00-21:00）']])
    ...
    confirm = actions('确认继续?', ['继续', '取消'],
                      help_text='请再次确认文件格式正确')
    put_text('------------这还是分割线------------')
    ...
    if confirm == '取消':
        ...
        try:
            ...
            for n, excel in enumerate(to_write_excel):
                ...
                al.excel_to_word('./模板/temp/' + excel,
