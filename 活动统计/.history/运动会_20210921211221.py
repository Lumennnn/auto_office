...
LastEditTime: 2021-09-21 21:12:21
LastEditors: Lumen
Description:
🐱‍🏍🐱‍🏍🐱‍🏍🐱‍🏍🐱‍🏍🐱‍🏍🐱‍🏍🐱‍🏍🐱‍🏍🐱‍🏍
'''

import auto_leave_copy as al
import pandas as pd
import os
...
for n, excel in enumerate(excel_list):
    print(n, excel)
    al.excel_to_word('./模板/temp/' + excel, the_people_name='志愿者', the_date1='',
                    the_thing='迎新志愿者', the_date2='二〇二一年九月二十日', the_n=n, moban='.\\模板\\迎新志愿活动.docx')